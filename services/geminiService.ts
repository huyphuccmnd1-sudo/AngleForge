...
export const generateScene = async (base64: string, mimeType: string, prompt: string): Promise<string> => {
    ...
    throw new Error('Scene generation failed. The model did not return an image part.');
};